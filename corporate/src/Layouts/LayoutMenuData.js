    ...
    useEffect(() => {
        ...
        if (iscurrentState === 'GetThingsDone') {
         ...
         if (iscurrentState === "YourBusinesses") {
          ...
          if (iscurrentState === "YourBusinessesRedux") {
            history("/your-businesses-redux");
            document.body.classList.add("twocolumn-panel");
          }
           if (iscurrentState === "YourBusinessesReduxAsync") {
             history("/your-businesses-redux-async");
             document.body.classList.add("twocolumn-panel");
           }
     ...
     const menuItems = [
       ...
       },
       {
         ...
         click: function (e) {
           e.preventDefault();
           setIscurrentState("YourBusinessesRedux");
         },
       },
       {
         id: "Settings",
         ...
         click: function (e) {
           e.preventDefault();
           setIscurrentState("YourBusinessesReduxAsync");
         },
       },
     ];
