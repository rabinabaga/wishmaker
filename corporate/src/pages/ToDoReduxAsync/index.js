                      ...
                      <>
                        {projects?.map((item) => (
                          <li
                            key={item?._id}
                            onClick={() =>
                              handleProjectSelect(todos, item?._id)
                            }
                          >
                            <Link
                  ...
                  {sortbystatus.map((item, key) => (
                    <React.Fragment key={key}>
                      {item.options.map((item, key) => (
                        <option value={item.value} selected={item.value===validation.values.status} key={key}>
                          {item.label}
              ...
              <Col lg={6}>
                ...
                >
                  {sortbypriority.map((item, key) => (
                    <React.Fragment key={key}>
                      {item.options.map((item, key) => (
                        <option value={item.value} key={key} selected={item.value===validation.values.priority}>
                          {item.label}
                        </option>
                      ))}
                    </React.Fragment>
